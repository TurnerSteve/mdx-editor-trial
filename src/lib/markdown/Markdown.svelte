<script lang="ts">
  ...
  $effect(() => {
    state.renderedHtml = md.render(state.markdown);
  });
...
<textarea
  ...
  rows="10"
  class="w-full p-3 font-mono border border-gray-300 rounded"
></textarea>

<div bind:this={containerEl} class="prose max-w-none mt-4">
